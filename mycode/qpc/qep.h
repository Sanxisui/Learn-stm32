 ...
 */
#define QM_TRAN(tatbl_) ((Q_HSM_UPCAST(me))->temp.tatbl = (struct QMTranActTable const *)(tatbl_), Q_RET_TRAN)

/*${QEP-macros::QM_TRAN_INIT} ..............................................*/
/*! Macro to call in a QM state-handler when it executes an initial
 * transition. Applicable only to ::QMsm subclasses.
 */
#define QM_TRAN_INIT(tatbl_) ((Q_HSM_UPCAST(me))->temp.tatbl = (struct QMTranActTable const *)(tatbl_), Q_RET_TRAN_INIT)
 ...
 */
#define QM_TRAN_EP(tatbl_) ((Q_HSM_UPCAST(me))->temp.tatbl = (struct QMTranActTable const *)(tatbl_), Q_RET_TRAN_EP)
